...
const RuleEditor: React.FC<{
  ...
  return (
    <div className="flex items-center gap-4 rounded-lg bg-gray-50 p-4 dark:!bg-gray-800">
      <input
        type="text"
        className="w-40 rounded-lg border border-gray-200 bg-gray-100 px-3 py-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-50"
      ...
      <input
        type="text"
        className="flex-1 rounded-lg border border-gray-200 bg-gray-100 px-3 py-2 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-50"
        value={rule.protocol}
...
const ProtocolRulesCard: React.FC = () => {
  ...
  return (
    <div className="flex h-72 flex-col rounded-xl bg-gray-50 p-6 shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-800">
          ...
          {filteredRules.length === 0 ? (
            ...
            filteredRules.map((rule) =>
              ...
              JSON.stringify(editingRule.ports) ===
                ...
                <div
                  key={`${rule.protocol}-${rule.ports.join(",")}`}
                  className="flex items-center justify-between rounded-lg bg-gray-50 p-1 dark:bg-gray-700"
                >
